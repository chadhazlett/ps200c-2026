...
\tau_{\text{ATE}} &= \E[Y_i(1)] - \E[Y_i(0)] \\[6pt]
    &= \E[Y_i(\rule{.4cm}{0.4pt}) \mid D_i= \rule{.4cm}{0.4pt}] - \E[Y_i(\rule{.4cm}{0.4pt}) \mid D_i=\rule{.4cm}{0.4pt}] \quad \text{consistency} \\[14pt]
    &= \E[\rule{.4cm}{0.4pt} \mid D_i= 1] - \E[\rule{.4cm}{0.4pt} \mid D_i = 0] \quad \text{ignorability} \\[14pt]
