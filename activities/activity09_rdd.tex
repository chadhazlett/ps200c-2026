...
\noindent\textbf{Question 3: A fuzzy twist on Medicare-at-65.}  Returning to the Medicare setting from Q1: in practice the age-65 cutoff doesn't \emph{determine} Medicare enrollment perfectly --- a few people are already on Medicare before 65 (via disability), and a few don't enroll right at 65.  Suppose the researcher finds:
...
\item Why is the reduced-form effect (0.45 days) \emph{smaller} than the per-complier effect you computed in (a)?
