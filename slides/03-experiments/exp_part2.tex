...
\begin{frame}{Notes for what to change}
Need to introduce the HC2 SEs a bit before just name dropping them everywhere. 

Would be good to more clearly make the case that design trumps analysis, since they do about the same in the example. 

How to do the Lin interaction with categorical (and block indicator) de-meaning.
