...
\bigskip
\onslide<4-> \textbf{Lesson 1:} Even large, consistent bodies of observational evidence can reflect confounding rather than causation.
\end{frame}

\begin{frame}{HRT, Act 2: The RCT gets it wrong too}
\small
...
\medskip
\onslide<2-> The trial was \textbf{halted early}. Physicians reversed course overnight. Millions of women stopped HRT.\\
\medskip
\onslide<3-> But the WHI enrolled women who were on average \textbf{63 years old}---10--20 years past menopause. Later reanalysis showed that for women near menopause, HRT likely \textit{is} protective. The ``timing hypothesis'' is now widely accepted, and guidelines have largely come back around.\\
\bigskip
\onslide<4-> \textbf{Lesson 2:} Even a large RCT isn't automatically credible. Design choices---who is enrolled, when you stop---and interpretation still require careful reasoning about assumptions. An experiment answers a causal question, but \textit{which} causal question depends on the design.
\end{frame}
